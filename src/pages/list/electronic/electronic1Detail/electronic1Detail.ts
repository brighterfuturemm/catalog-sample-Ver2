...
import * as myGlobals from '../electronic';
var page=new myGlobals1.ListPage(myGlobals1.h1,myGlobals1.h2,myGlobals1.h3);
@IonicPage()
@Component({
  selector: 'page-electronic1Detail',
  templateUrl: 'electronic1Detail.html'
})

export class electronic1DetailPage {
 posts: any;
 load:any;
  constructor(public navCtrl: NavController, public http: Http) {
        this.posts=myGlobals1.electronic1[myGlobals.k1];
  }
