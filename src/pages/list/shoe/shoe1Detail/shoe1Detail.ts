...
import * as myGlobals from '../shoe';
var page=new myGlobals1.ListPage(myGlobals1.h1,myGlobals1.h2,myGlobals1.h3);
@IonicPage()
@Component({
	selector: 'page-shoe1Detail',
	templateUrl: 'shoe1Detail.html'
})

export class shoe1DetailPage {
	posts: any;
	
	constructor(public navCtrl: NavController, public http: Http) {
        this.posts=myGlobals1.shoe1[myGlobals.k1];
    }
