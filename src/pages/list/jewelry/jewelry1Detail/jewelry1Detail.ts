...
import * as myGlobals from '../jewelry';
var page=new myGlobals1.ListPage(myGlobals1.h1,myGlobals1.h2,myGlobals1.h3);
@IonicPage()
@Component({
  selector: 'page-jewelry1Detail',
  templateUrl: 'jewelry1Detail.html'
})

export class jewelry1DetailPage {
 posts: any;
 load:any;
  constructor(public navCtrl: NavController, public http: Http) {
        this.posts=myGlobals1.jewelry1[myGlobals.k1];
  }
 doRefresh(refresher) {
